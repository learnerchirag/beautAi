...
export function TextInput({
  ...
  return (
    <View className="flex-col gap-1 w-full">
      ...
      {/* Input field */}
      <View
        className={`bg-core-white border rounded-xs flex-row items-center px-3 py-3 gap-1 ${
          error ? "border-deep-crimson" : "border-grey-200"
        }`}
      >
        <RNTextInput
          className="flex-1 font-josefin-regular text-body-md text-core-black tracking-[-0.35px]"
          value={value}
