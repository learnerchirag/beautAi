...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "body-sm": ["12px", { letterSpacing: "-0.3px" }],
        "body-md": ["14px", { letterSpacing: "-0.35px" }],
        "body-lg": ["16px", { letterSpacing: "-0.4px" }],
        "display-md": ["21px", { letterSpacing: "-0.63px" }],
        "display-xl": ["40px", { letterSpacing: "-1.6px" }],
      },
    },
  },
  plugins: [],
